...
var (
	...
	baseURL       string = "https://github.com/MetaCubeX/clash/releases/download/Prerelease-Alpha/clash"
	versionURL    string = "https://github.com/MetaCubeX/clash/releases/download/Prerelease-Alpha/version.txt"
	packageURL    string
...
func init() {
	...
	if !strings.HasPrefix(C.Version, "alpha") {
		baseURL = "https://github.com/MetaCubeX/clash/releases/latest/download/clash"
		versionURL = "https://github.com/MetaCubeX/clash/releases/latest/download/version.txt"
	}
}
...
func prepare(exePath string) (err error) {
	...
	if runtime.GOOS == "windows" {
		...
		updateExeName = "clash-android-arm64-v8"
	} else {
...
func downloadPackageFile() (err error) {
	...
	defer cancel()
	resp, err := clashHttp.HttpRequest(ctx, packageURL, http.MethodGet, nil, nil)
	if err != nil {
...
func getLatestVersion() (version string, err error) {
	...
	defer cancel()
	resp, err := clashHttp.HttpRequest(ctx, versionURL, http.MethodGet, nil, nil)
	if err != nil {
